...
<h2 align="center">Current Week Documents Summary (<?php echo "Start Date: ".$fromdate." End Date: ".$todate ?>)<br /> All Files (PDF,DOC,XLSX,TXT,JPG,GIF,PNG,DWG and Others)</h2>
