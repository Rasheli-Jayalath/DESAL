<?php
	...
	if($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "localhost:8080" || $_SERVER['HTTP_HOST'] == "14.141.114.205" || $_SERVER['HTTP_HOST'] == "10.100.65.117" || $_SERVER['HTTP_HOST'] == "india-sdms.smecnet.com")
	{
